...
ALTER TABLE detalle_evaluacion ADD CONSTRAINT detalle_evaluacion_pk PRIMARY KEY ( evaluacion_id_evaluacion, id_criterio );
...
ALTER TABLE plaza
    ADD CONSTRAINT plaza_contacto_fk FOREIGN KEY ( id_contacto_plaza )
